...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (typeof authorized !== 'undefined') where.authorized = authorized;
    if (typeof start !== 'undefined') where.start = start;
    if (typeof resume !== 'undefined') where.resume = resume;
    ...
    const query = await Applicant.findAndCountAll(find);
    ...
    console.error('get many applicant error', e);
    res.status(500);
    return res.json({
